...
get_widget_file_summary = "Get a file from a widget package"
get_widget_file_description = " Get a file from a widget package. The file can be any file included in the widget package, including the entry point file (if it is a widget). The entry point file is the one that will be used to render the widget in the platform."
...
get_widget_file_not_found_response_description = "Widget code not found."
get_widget_file_bad_gateway_response_description = "Widget code was not encoded using the specified charset."
