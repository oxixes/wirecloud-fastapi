...
get_static_file_description = "Get a static file."
get_static_file_response_description = "Static file"
get_static_file_not_found_response_description = "Static file not found"
get_static_file_validation_error_response_description = "Invalid parameters"