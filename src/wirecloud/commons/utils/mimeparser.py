...
def parse_mime_type(mime_type: str, split_type: bool = False) -> Union[tuple[str, str, dict[str, str]], tuple[str, dict[str, str]]]:
...
def fitness_and_quality_parsed(mime_type: str, parsed_ranges: list[tuple[str, str, dict[str, str]]]) -> tuple[int, float]:
...
def best_match(supported: list[str], header: str) -> str:
